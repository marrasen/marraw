...
func TestRenderPreviewExposureDelta(t *testing.T) {
	...
	base := meanLuma(RenderPreview(src, 64, 0.72, e, 0, nil, nil, nil))
	up := meanLuma(RenderPreview(src, 64, 0.72, e, 1, nil, nil, nil))
	down := meanLuma(RenderPreview(src, 64, 0.72, e, -1, nil, nil, nil))
